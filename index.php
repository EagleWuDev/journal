...
<body data-spy="scroll" data-target=".navbar-collapse">
 ...
 <div class="container contentContainer" id="topContainer">
  		<div class="row">
 			 ...
 			 <h1 class="marginTop">Journal</h1>
 			 
 			 <p class="lead">Your own private journal to record your thoughts and plan yourself.</p>
 			 ...
 			 <p class="bold marginTop">Want to get started? Sign Up Below!</p>
